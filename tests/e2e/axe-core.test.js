...
const KNOWN_FIXTURE_ISSUES = {
  ...
  'good-images-of-text.html': ['color-contrast'],
  'good-low-background-audio.html': ['color-contrast'],
  'good-target-size.html': ['color-contrast'],
  ...
  'good-motion-vestibular.html': ['color-contrast'],
