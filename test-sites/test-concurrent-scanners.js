...
const CONCURRENT_SCANNERS = {
  'color-contrast': { module: '../src/color-contrast-scanner' },
  ...
  'input-purpose': { module: '../src/input-purpose-scanner' },
  'language-detection': { module: '../src/language-detection-scanner' },
  'predictable-navigation': { module: '../src/predictable-navigation-scanner' },
  'error-handling': { module: '../src/error-handling-scanner' },
  'html-validation': { module: '../src/html-validation-scanner' },
  'page-structure': { module: '../src/page-structure-scanner' },
  'label-in-name': { module: '../src/phase6a-label-in-name-scanner' },
  'status-messages': { module: '../src/phase6a-status-messages-scanner' },
  'advanced-aria': { module: '../src/phase6b-advanced-aria-scanner' },
  'timing-controls': { module: '../src/timing-controls-scanner' },
};
