...
class ImagesOfTextScanner {
  ...
  /**
   * Scan for images of text violations
   * @param {string} url - URL to scan
   * @param {Object} options - Scanning options
   * @param {boolean} options.useOCR - AI-powered text detection (placeholder)
   * @param {boolean} options.skipLogos - Skip logo images
   * @param {boolean} options.skipDecorative - Skip decorative images
   * @returns {Promise<Object>} ImageTextReport
   */
  async scanImagesOfText(url, options = {}) {
    const defaultOptions = {
      useOCR: false, // Placeholder for future OCR integration
      skipLogos: true,
      skipDecorative: true
    };
